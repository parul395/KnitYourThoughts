...
$sql = "SELECT user_id FROM forgotpassword WHERE kkey='$key' AND user_id='$user_id' AND time > '$time' AND status='pending'";
...
$sql = "UPDATE forgotpassword SET status='used' WHERE kkey='$key' AND user_id='$user_id'";
$result = mysqli_query($link, $sql);
if(!$result){
